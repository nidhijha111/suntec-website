...
const stepsData = [
  {
    ...
    stepNumber: "Step 1",
    variant: "blue", 
    description: "Visit suntec's website www.suntecinsurance.com Click on the 'Commercial Vehicle' icon on the Home Page or from the 'Products' tab."
  },
  {
    id: 'step2',
    stepNumber: "Step 2",
  ...
  },
  {
    ...
    stepNumber: "Step 3",
    variant: "blue",
    description: "Our Insurance advisor will provide all the necessary information to help you choose the policy that best suits your needs."
  },
  {
    id: 'step4',
    stepNumber: "Step 4",
  ...
  },
  {
    ...
    stepNumber: "Step 5",
    variant: "blue",
    description: "Your goods-carrying vehicle Insurance policy will be mailed to you after paying the premium."
  }
];
